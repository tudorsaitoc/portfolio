...
function buildLocalCommands(cli, isLocalSite) {
  ...
  function getCommandHandler(command, handler) {
    return argv => {
      ...
      const args = Object.assign(Object.assign(Object.assign({}, argv), siteInfo), {}, {
  ...
  cli.command({
    ...
    handler: handlerP(({
      ...
      if (typeof recipe !== `string`) {
        throw new Error(`Error: gatsby recipes needs to be called with a specific recipe`);
      }

      (0, _recipes.recipesHandler)(recipe);
    })
  });
}
...
function isLocalGatsbySite() {
  ...
  try {
    const _require = require(_path.default.resolve(`./package.json`)),
...
const createCli = argv => {
  ...
  return cli.command({
    ...
    handler: handlerP( /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2.default)(function* ({
        ...
        yield (0, _initStarter.initStarter)(starterStr, rootPathStr);
      });
